...
Contribution data is cached in memory for one hour. GitHub API failures reuse the last successful payload when one exists. Successful SVGs are sent with `Cache-Control: public, max-age=3600`.
